...
type Repository interface {
	...
	GetTodo(ctx context.Context, userID uuid.UUID, todoID uuid.UUID) (entity.Todo, error)
	...
	UpdateTodosBody(ctx context.Context, userID uuid.UUID, todoID uuid.UUID, newBody string) error
	UpdateTodosDeadline(ctx context.Context, userID uuid.UUID, todoID uuid.UUID, deadline time.Time) error
